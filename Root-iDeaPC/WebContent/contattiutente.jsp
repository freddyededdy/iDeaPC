		...
		<div class="content">
			<article class="topcontent">
				...
				<footer>
				 ...
				 <p>Siamo una semplice pizzeria
				 <br>
				 
				 Via Appia, 156, 83042 Atripalda AV
<br>
                 Tel:0825 624654
                 <br>
                 Vi aspettiamo!
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA14tEmgx9Zt2HaYyQhac5nRCfJdK7KG80&callback=myMap"></script>
<script>
function myMap() {
var mapProp= {
    center:new google.maps.LatLng(40.914224, 14.817516),
