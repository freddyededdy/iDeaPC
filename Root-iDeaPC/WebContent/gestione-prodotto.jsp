	...
	<div class="MainContent">
		...
		<div class="content">
			...
			<h2>
				...
				<button type="submit" class="waves-effect waves-light btn" alt="Aggiungiprodotto" title="Aggiungi prodotto" style="float:right;">  <i class="tiny material-icons">playlist_add</i></button>
				</form>
			</h2>
			</header> <footer>
			...
			<table id="myTable">
				...
				<tr>
					...
					<td>
						...
						<button type="submit" class="waves-effect waves-light btn">  <i class="tiny material-icons">mode_edit</i></button>
							</form>
						<form action="EliminaProdottoController" method="post">
							<input type="hidden" name="id" value="<%=pr.getId_prod()%>" /> 
							<button type="submit" class="waves-effect waves-light btn">  <i class="tiny material-icons">delete</i></button>
							</form>
					</td>
				</tr>
