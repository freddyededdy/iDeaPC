	...
	<li><a href="Admin.jsp"> Home admin</a></li>	
        ...
        <div class="col s12 m7">
          <div class="card">
            <div class="card-image">
              <img src="pizzeria3.jpg">
              <span class="card-title">Gestione prodotti</span>
            </div>
            <div class="card-content">
              <p>Questa è la sezione dedicata all'aggiunta o alla modifica dei prodotti della casa</p>
            </div>
        ...
        <div class="col s12 m7">
          <div class="card">
            ...
            <div class="card-content">
              <p>Questa è la sezione dedicata alla modifica dei dati dei clienti iscritti al sito!</p>
            </div>
            <div class="card-action">
        ...
        <div class="col s12 m7">
          <div class="card">
            <div class="card-image">
              <img src="pizzeria3.jpg">
              <span class="card-title">Gestione ordinazioni</span>
            </div>
            <div class="card-content">
              <p>Questa è la sezione dedicata  alla gestione delle ordinazioni effettutate dagli iscritti al sito</p>
            </div>
            <div class="card-action">
